...
import { DomEditor, IDomEditor } from "@wangeditor3/core-yourcs"
...
describe("paragraph plugin", () => {
  ...
  it("delete to clear text", () => {
    ...
    const selectedParagraph1 = DomEditor.getSelectedNodeByType(
      editor,
      "paragraph"
    )
    ...
    const selectedParagraph2 = DomEditor.getSelectedNodeByType(
      editor,
      "paragraph"
    )
