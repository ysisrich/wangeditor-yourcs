...
import ImageSurroundLeft from "./ImageSurroundLeft"
import ImageSurroundRight from "./ImageSurroundRight"
import ImageSurroundClear from "./ImageSurroundClear"
...
export const ImageSurroundLeftMenuConf = {
  key: "imageSurroundLeft",
  factory() {
    return new ImageSurroundLeft()
  }
}

export const ImageSurroundRightMenuConf = {
  key: "imageSurroundRight",
  factory() {
    return new ImageSurroundRight()
  }
}

export const ImageSurroundClearMenuConf = {
  key: "imageSurroundClear",
  factory() {
    return new ImageSurroundClear()
  }
}
