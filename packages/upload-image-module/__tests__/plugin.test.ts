...
import * as basicModule from "@wangeditor3/basic-modules-yourcs"
...
describe("withUploadImage plugin", () => {
  beforeEach(() => {
    ...
    jest
      .spyOn(basicModule, "isInsertImageMenuDisabled")
  ...
  test("withUploadImage plugin should invoke insertData with text data if transfer data contains plain text ", () => {
    ...
    const newEditor = withUploadImage(editor)
    jest
      .spyOn(DataTransfer.prototype, "getData")
      .mockImplementation(() => "plain text")
